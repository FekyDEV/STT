...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .setDescription('Approve a suggestion (Moderators Only)')
            ...
            if (!channel) {
                ...
                if (suggestion === false) {
                    ...
                    let suggestApprove = new MessageEmbed()
                        .setTitle(`<:a:871419569426804796> Suggestion from ${suggestion.userName}`)
                        .setDescription("⠀**╚ was Approved !**")
                    ...
                    interaction.client.channels.cache.get(data.approveChannel).send({ embeds: [suggestApprove] });
                    interaction.reply({ ephemeral: true, content: `You approved suggestion \`${suggestion.suggestID}\`` });
